...
# Preprocessing
RUN git clone https://github.com/Wedge-Oxford/dpclust_smchet_docker
...
# RC  pipeline
RUN git clone https://github.com/sdentro/randomclone
ADD randomclone /opt/galaxy/tools/dpclust/randomclone
RUN git clone https://github.com/sdentro/smchet_utils
...
RUN git clone https://github.com/sdentro/MutationTime.R
